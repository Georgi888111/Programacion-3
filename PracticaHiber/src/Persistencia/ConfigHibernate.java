...
public class ConfigHibernate {
    ...
    public static void load() {
        ...
        try {
            ...
            config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/practicahiber");
            ...
            config.addAnnotatedClass(BonoSueldo.class);
            config.addAnnotatedClass(Empleado.class);
            config.addAnnotatedClass(GrupoFamiliar.class);
            config.addAnnotatedClass(ItemBono.class);
