...
public class Controlador {
    ...
    //Constructor inicializa configHibernate
    public Controlador() {
    ...
    public void guardar(Object o) throws Exception {
        ...
        //Transaction, permite realizar operaciones contra la transacción en el objeto de transacción de destino.
        Transaction tx = null;
        try {
    ...
    public static void setHu(ConfigHibernate configHibernate) {
        Controlador.configHibernate = configHibernate;
    }
