...
Conexion conexion = new Conexion();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int idPais = Integer.valueOf(request.getParameter("paises"));
        ArrayList<Provincia> provincias = conexion.traeProvincias(idPais);
    ...
    public ArrayList<Pais> traePaises(){
       ArrayList<Pais>paises = conexion.traePaises();
       return paises;
    }
}
